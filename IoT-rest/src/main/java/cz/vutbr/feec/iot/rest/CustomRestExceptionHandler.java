...
import cz.vutbr.feec.iot.rest.exception.ResourceNotCreatedException;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> handleResourceNotCreatedException(final Exception ex,
      final HttpHeaders headers, final HttpStatus status, final WebRequest request) {
    final ApiError apiError = new ApiError(HttpStatus.INTERNAL_SERVER_ERROR,
        ex.getLocalizedMessage(), "Resource not created");
    return new ResponseEntity<>(apiError, new HttpHeaders(), apiError.getStatus());
  }
